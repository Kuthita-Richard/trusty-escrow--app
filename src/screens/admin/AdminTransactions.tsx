    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Manage and monitor all platform transactions</p>
        </div>
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          ...
                          {transaction.status === "pending" && (
                            <Button variant="ghost" size="icon" onClick={() => handleConfirmDeposit(transaction.id)}>
                              <CheckCircle2 className="h-4 w-4 text-success" />
                            </Button>
                          )}
                          {transaction.status === "delivered" && (
                            <Button variant="ghost" size="icon" onClick={() => handleReleaseFunds(transaction.id)}>
                              <CheckCircle2 className="h-4 w-4 text-success" />
                            </Button>
                          )}
                        </div>
